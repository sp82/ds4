...
# --- moebench routed MoE microbenchmark (real DeepSeek Flash expert dims) ---
...
$(KBENCH_DIR)/moebench_cuda.o: $(KBENCH_DIR)/moebench.c ds4_gpu.h
	$(CC) $(CFLAGS) -I. -c -o $@ $(KBENCH_DIR)/moebench.c

moebench-cuda: $(KBENCH_DIR)/moebench_cuda.o ds4_cuda.o ds4_image.o $(MMQ_OBJS)
	$(DS4_LINK) -o $@ $^ $(DS4_LINK_LIBS)
...
tests/test_mgpu_config.o: tests/test_mgpu_config.c ds4_layer_pack.h
	$(CC) $(CFLAGS) -I. -c -o $@ $<

tests/test_mgpu_config: tests/test_mgpu_config.o ds4_layer_pack.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)
